...
__kernel void graying(__global const uchar* img_test_in, __global uchar* img_test_out, const unsigned int ROWS, const unsigned int COLS, const unsigned int CHANNELS)
{
    #pragma unroll
